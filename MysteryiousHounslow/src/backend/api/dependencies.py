...
from src.backend.core.exceptions import AuthenticationException, RateLimitException
...
# Removed get_database_session - direct DB access not allowed
# All data access must go through Hasura GraphQL
