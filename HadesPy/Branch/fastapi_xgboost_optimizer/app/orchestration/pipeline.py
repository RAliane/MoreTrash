...
class ConstraintValidationStage(PipelineStage):
    ...
    async def execute(self, context: PipelineContext) -> None:
        ...
        try:
            ...
            hard_constraints = [
                c for c in context.request.constraints
    ...
    async def _validate_hard_constraint(
        ...
        if constraint.spatial_constraint:
            ...
            await self._validate_mathematical_constraint(constraint.mathematical_constraint)
...
class HardConstraintEnforcementStage(PipelineStage):
    ...
    async def execute(self, context: PipelineContext) -> None:
        ...
        try:
            ...
            spatial_constraints = [
                c for c in hard_constraints if c.spatial_constraint
            ]
...
class SoftConstraintScoringStage(PipelineStage):
    ...
    async def _score_soft_constraint(
        ...
        if constraint.spatial_constraint:
            ...
            base_score -= abs(1.0 - utilization) * 0.5  # Penalty for over/under utilization
...
class OptimizationStage(PipelineStage):
    ...
    async def execute(self, context: PipelineContext) -> None:
        ...
        try:
            ...
            context.metadata["convergence_history"] = context.genetic_optimizer.get_convergence_history()
...
class SolutionValidationStage(PipelineStage):
    ...
    async def execute(self, context: PipelineContext) -> None:
        ...
        try:
            ...
            validation_rate = valid_solutions / total_solutions if total_solutions > 0 else 0.0
    ...
    async def _check_constraint_satisfaction(
        ...
        if constraint.mathematical_constraint:
            return self._check_mathematical_constraint(solution, constraint.mathematical_constraint)
